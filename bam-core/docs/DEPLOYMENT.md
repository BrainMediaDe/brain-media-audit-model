...
## Unterschied zu BAM Enterprise

Dieses Deployment ist **Single-User / Single-Tenant** und ohne
Authentifizierung gedacht fuer den internen Gebrauch (z. B. eigene
Compliance-Abteilung). Fuer Mandantenfaehigkeit (Multi-Tenant),
White-Label, API-Key-Verwaltung, automatische Framework-Updates und
SLA-Support siehe **BAM Enterprise**: [brain-media.de](https://brain-media.de).
